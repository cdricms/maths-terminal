    ...
    <div id="container-error">
        ...
        <div id="error-title">
            ...
            <div id="error-explications">
                <p> Nous sommes vraiment désolés pour cette inconvénient. Il semble que tu essaies d'accéder à une page qui a était supprimée ou qui n'a jamais existé.
                </p>
            </div>
            <!-- End/error-explications -->
        </div>
        <!-- End/error-title -->
    </div>
    <!-- End/container-error -->
